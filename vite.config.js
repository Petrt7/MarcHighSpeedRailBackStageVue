...
export default defineConfig({
  ...
  server: {
    ...
    proxy:{
      "/tovite":{
        target: "http://114.32.211.158:5175/api", //when you deploy your develop setup in localhost , it will connect to home base proxy server ,which will redirect to real backend server.  
        changeOrigin:true,
